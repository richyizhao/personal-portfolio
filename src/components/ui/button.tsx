...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 cursor-pointer items-center justify-center rounded-md border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-xs [a]:hover:bg-primary/80",
        outline:
          "border-border bg-background text-muted-foreground shadow-xs hover:bg-muted aria-expanded:bg-muted aria-expanded:text-foreground dark:border-none dark:bg-black/50 dark:hover:bg-black/30",
        secondary:
          "border-border bg-zinc-50 text-black hover:bg-muted aria-expanded:bg-zinc-200 aria-expanded:text-black dark:border-none dark:bg-zinc-900 dark:text-white dark:hover:bg-zinc-700",
        ghost:
